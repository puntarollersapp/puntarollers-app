...
import ClinicaSeptExperience from './pages/ClinicaSeptExperience'
import ClinicaSeptDiploma from './pages/ClinicaSeptDiploma'
import ClinicaSeptResultados from './pages/ClinicaSeptResultados'
...
function AppRoutes(){return <><ScrollToTop/><Routes><Route path="/" element={<Home/>}/><Route path="/login" element={<Login/>}/><Route path="/rollerfeed" element={<PublicRollerFeed/>}/><Route path="/ranking-semanal" element={<PublicWeeklyRanking/>}/><Route path="/inscripciones-2026" element={<Inscripciones2026/>}/><Route path="/inscripciones-kids-2026" element={<PRKidsInscripciones2026/>}/><Route path="/clinica-miguel-septiembre" element={<ClinicaMiguelSept2026/>}/><Route path="/clinica-septiembre-2026" element={<ClinicaSeptExperience/>}/><Route path="/clinica-septiembre-2026/diploma" element={<ClinicaSeptDiploma/>}/><Route path="/clinica-septiembre-2026/resultados" element={<ClinicaSeptResultados/>}/><Route path="/clinica-miguel-octubre" element={<ClinicaMiguelOct2026/>}/><Route path="/personalizadas" element={<Personalizadas/>}/><Route path="/bienvenido" element={<WelcomeAccess/>}/><Route path="/soy-nuevo" element={<Navigate to="/bienvenido" replace/>}/><Route path="/alianza" element={<Alianza/>}/><Route path="/cuponeras" element={<Cuponeras/>}/><Route path="/pasaporte-kids" element={<PasaporteKids/>}/><Route path="/uniformes" element={<Uniformes/>}/><Route path="/tracking" element={<Tracking/>}/><Route path="/terminos" element={<Terminos/>}/><Route path="/app/dashboard" element={<PrivateRoute><Dashboard/></PrivateRoute>}/><Route path="/app/perfil" element={<PrivateRoute><ProfileWithAmigosPR/></PrivateRoute>}/><Route path="/app/avatar" element={<PrivateRoute><Navigate to="/app/avatar-premium" replace/></PrivateRoute>}/><Route path="/app/avatar-premium" element={<PrivateRoute><AvatarPremiumPreview/></PrivateRoute>}/><Route path="/app/evolucion" element={<PrivateRoute><MiEvolucion/></PrivateRoute>}/><Route path="/app/entrenamiento" element={<PrivateRoute><MyActivity/></PrivateRoute>}/><Route path="/app/deberes" element={<PrivateRoute><PRTraining/></PrivateRoute>}/><Route path="/app/insignias" element={<PrivateRoute><Insignias/></PrivateRoute>}/><Route path="/app/musica" element={<PrivateRoute><MusicPage/></PrivateRoute>}/><Route path="/app/strava/callback" element={<PrivateRoute><StravaCallback/></PrivateRoute>}/><Route path="/app/prcard" element={<PrivateRoute><PRCardPage/></PrivateRoute>}/><Route path="/app/tracking" element={<PrivateRoute><Tracking/></PrivateRoute>}/><Route path="/app/moments" element={<PrivateRoute><PRMoments/></PrivateRoute>}/><Route path="/app/actividad" element={<PrivateRoute><ActivityWithPinnedPodium/></PrivateRoute>}/><Route path="/app/servicios" element={<PrivateRoute><ServicesPage/></PrivateRoute>}/><Route path="/app/contenido" element={<PrivateRoute><ContentPage/></PrivateRoute>}/><Route path="/app/tienda" element={<PrivateRoute><StorePage/></PrivateRoute>}/><Route path="/app/comunidad" element={<PrivateRoute><CommunityPage/></PrivateRoute>}/><Route path="/app/mensajes" element={<PrivateRoute><MessagesPage/></PrivateRoute>}/><Route path="/admin" element={<AdminRoute><><Admin/><PRControlHub/><AdminProfileShortcut/></></AdminRoute>}/><Route path="/admin/inscripciones-2026" element={<FullAdminRoute><AdminInscripciones2026/></FullAdminRoute>}/><Route path="/admin/personalizadas" element={<FullAdminRoute><AdminPersonalizadasBulk/></FullAdminRoute>}/><Route path="/admin/nuevos-accesos" element={<FullAdminRoute><AdminAccessRequests/></FullAdminRoute>}/><Route path="/tesoreria" element={<TreasuryRoute><PRTesoreria/></TreasuryRoute>}/><Route path="/admin/tesoreria" element={<TreasuryRoute><PRTesoreria/></TreasuryRoute>}/><Route path="/admin/emails" element={<FullAdminRoute><PREmailsAdmin/></FullAdminRoute>}/><Route path="/admin/performance" element={<FullAdminRoute><PRPerformance/></FullAdminRoute>}/><Route path="/app" element={<Navigate to="/app/perfil" replace/>}/><Route path="*" element={<Navigate to="/" replace/>}/></Routes></>}
